...
export const images = {
  flamecoach: {
    tile: flamecoachThumb,
    hoveredTile: flamecoachHover,
  },
  flamecoach2: {
    tile: flamecoach2Thumb,
    hoveredTile: flamecoach2Hover,
  },
  aufwind: {
    tile: aufwindThumb,
    hoveredTile: aufwindHover,
  },
  oddy: {
    tile: oddyThumb,
    hoveredTile: oddyHover,
  },
  vodafoneOMR: {
    tile: vodafoneOMRThumb,
    hoveredTile: vodafoneOMRHover,
  },
  vodafoneGigacar: {
    tile: vodafoneGigacarThumb,
    hoveredTile: vodafoneGigacarHover,
  },
  softrevision: {
    tile: softrevisionThumb,
    hoveredTile: softrevisionHover,
  },
  schumann: {
    tile: schumannThumb,
    hoveredTile: schumannHover,
  },
  essen: {
    tile: essenThumb,
    hoveredTile: essenHover,
  },
  tirol: {
    tile: tirolThumb,
    hoveredTile: tirolHover,
  },
  thyssenInfra: {
    tile: thyssenInfraThumb,
    hoveredTile: thyssenInfraHover,
  },
  trikottaufe: {
