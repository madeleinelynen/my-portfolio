...
function SoftRevisionPage() {
  ...
  return (
    <ProjectPage
      ...
      role="Programmierung mit Fokus auf der Entwicklung eines angepassten Hand-Greifsystems und Highscore 
      System, UX/UI-Integration und -Programmierung, Hand-Tracking Implementierung"
