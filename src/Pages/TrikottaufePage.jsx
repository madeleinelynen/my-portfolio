...
function TrikottaufePage() {
  ...
  return (
    ...
    <ProjectPage
      ...
      role="Verantwortlich für die Programmierung der Trikot-Animation und der UI-Funktionen sowie für 
      die fristgerechte Veröffentlichung der App im Apple App Store."
